...
const MULTI_ACCOUNT: &str = r#"{"_state":{"users":[{"id":"695526392107892786","username":"4n6h4x0r","discriminator":"0","avatar":"abc","tokenStatus":2}]}}"#;
...
fn minted_leveldb_round_trips_all_artifact_classes() {
    ...
    assert_eq!(account.user_id.as_deref(), Some("695526392107892786"));
    assert_eq!(account.username.as_deref(), Some("4n6h4x0r"));
