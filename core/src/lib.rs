...
mod tests {
    ...
    const MULTI: &str = r#"{"_state":{"users":[{"id":"695526392107892786","username":"4n6h4x0r","discriminator":"0","avatar":"a","tokenStatus":2}]}}"#;
    ...
    fn decode_aggregates_all_artifact_classes() {
        ...
        assert_eq!(artifacts.accounts[0].username.as_deref(), Some("4n6h4x0r"));
    }
