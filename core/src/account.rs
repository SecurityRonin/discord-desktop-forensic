...
mod tests {
    ...
    const MULTI: &str = r#"{"_state":{"users":[{"id":"695526392107892786","avatar":"c71a53fdf6f3b2d92ab1aa49f2bbd806","username":"4n6h4x0r","discriminator":"0","tokenStatus":2}]}}"#;
    ...
    fn parses_multi_account_store_users() {
        ...
        let a = &accounts[0];
        assert_eq!(a.user_id.as_deref(), Some("695526392107892786"));
        assert_eq!(a.username.as_deref(), Some("4n6h4x0r"));
        assert_eq!(a.discriminator.as_deref(), Some("0"));
        assert_eq!(
            a.avatar.as_deref(),
            Some("c71a53fdf6f3b2d92ab1aa49f2bbd806")
        );
    ...
    fn minimal_account_from_caches_when_no_store() {
        ...
        let accounts = extract_accounts(&recs);
        assert_eq!(accounts.len(), 1);
        assert_eq!(accounts[0].user_id.as_deref(), Some("695526392107892786"));
        assert_eq!(accounts[0].email.as_deref(), Some("agent@example.com"));
